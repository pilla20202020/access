...
@section('content')
    <section>
        <div class="section-body">
            <div class="card">
                <div class="card-head">
                    <header class="text-capitalize">Registration</header>
                </div>
                <div class="card-body p-5">
                   <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <label>Highest Qualification Year: <span>{{$registration->highest_qualification}}</span></label>
                        </div>
                        ...
                        <div class="col-md-3">
                            <label>Highest Qualification Stream: <span>{{$registration->highest_stream}}</span></label>
                        </div>

                        <div class="col-md-3">
                            <label>Highest Qualification College: <span>{{$registration->highest_college}}</span></label>
                        </div>
                    </div>
                    <hr>
